...
export default function QuizCard({ question, index }: QuizCardProps) {
  ...
  return (
    <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white shadow-sm dark:shadow-none dark:bg-white/5 p-6 space-y-4">
      {/* Question */}
      ...
      <div className="space-y-2 pl-10">
        {question.options.map((option) => {
          let style = 'border-slate-200 dark:border-white/10 bg-white shadow-sm dark:shadow-none dark:bg-white/5 text-slate-600 dark:text-slate-300 hover:border-slate-300 dark:border-white/20 hover:bg-white/10';
      ...
      {isAnswered && (
        <div className="pl-10 space-y-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 text-xs text-slate-500 dark:text-slate-400 hover:text-violet-300 transition-colors"
          >
          ...
          {showExplanation && (
            <div className="rounded-xl border border-slate-200 dark:border-white/10 bg-white shadow-sm dark:shadow-none dark:bg-white/5 px-4 py-3 text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
