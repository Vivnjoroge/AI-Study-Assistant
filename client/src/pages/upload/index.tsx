      ...
      <div className="mb-10 text-center">
        ...
        <div className="mt-4 flex flex-wrap justify-center gap-2">
          {['Text extraction', 'Smart chunking', 'Vector embeddings', 'Instant search'].map((f) => (
            <span key={f} className="rounded-full bg-white shadow-sm dark:shadow-none dark:bg-white/5 border border-slate-200 dark:border-white/10 px-3 py-1 text-xs text-slate-500 dark:text-slate-400">
              ✓ {f}
            </span>
          ))}
        </div>
